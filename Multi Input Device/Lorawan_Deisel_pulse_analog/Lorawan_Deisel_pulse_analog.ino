...
void setup()
{
  ...
  Serial.println("------------------------------------------------------");
  uint8_t flash_value[10];
  api.system.flash.get(6600, flash_value, 10);
...
void loop()
{
  ...
  Serial.println("Reading DESEIL METER");
  Serial.print("Volume: ");
  ...
  String total = cubicliter + "." + cubic_dec;
  ...
  api.system.flash.set(6600, flash_value,10);
    last = millis();
    uplink_routine();
  }
