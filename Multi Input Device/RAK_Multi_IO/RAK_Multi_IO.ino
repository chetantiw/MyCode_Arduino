...
void uplink_routine()
{
 ...
 if(para1!="-1")
 json["RSCH1"] = String(para1);
 if(para2!="-1")
 json["RSCH2"] = String(para2);

 
 json["ACH1"] = String(analogRead(ACH1));
 json["ACH2"] = String(analogRead(ACH2));
 json["ACH3"] = String(analogRead(ACH3));
 json["DCH1"] = String(digitalRead(DCH1));
 json["DCH2"] = String(digitalRead(DCH2));
 json["DCH3"] = String(digitalRead(DCH3));
...
void loop()
{
  ...
  //Serial.println("Wakeup..");
    ...
    Serial.println("Reading PH sensor with MODBUS: ");
  ...
  Serial.println("Reading Analog INPUT: ");
    ...
    Serial.print("ACH 1: ");
    Serial.print(analogRead(ACH1));
    Serial.print(",");
    Serial.print("ACH 2: ");
    Serial.print(analogRead(ACH2));
    Serial.print(",");
    Serial.print("ACH 3: ");
    Serial.println(analogRead(ACH3));
    delay(2000);
    
  Serial.println("Reading Digital INPUT: ");
  
    Serial.print("DCH 1: ");
    Serial.print(digitalRead(DCH1));
    Serial.print(",");
    Serial.print("DCH 2: ");
    Serial.print(digitalRead(DCH2));
    Serial.print(",");
    Serial.print("DCH 3: ");
    Serial.println(digitalRead(DCH3));
    delay(2000);
}
