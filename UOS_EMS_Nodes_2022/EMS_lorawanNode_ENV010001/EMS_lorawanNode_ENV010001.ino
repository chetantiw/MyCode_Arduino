...
// Net  Session Key (MSB) 07    08    22    8f    b4    bf    c6    23    68    1d    38    a3    0d    e4    4e   c2
uint8_t NwkSkey[16] = { 0x07, 0x08, 0x22, 0x8f, 0xb4, 0xbf, 0xc6, 0x23, 0x68, 0x1d, 0x38, 0xa3, 0x0d, 0xe4, 0x4e, 0xc2 };

// App Session Key (MSB)  98    24    0c    0e    f9    49    29    d6    f1    a7    67    4a    d1    25    e1    c3 
uint8_t AppSkey[16] = { 0x98, 0x24, 0x0c, 0x0e, 0xf9, 0x49, 0x29, 0xd6, 0xf1, 0xa7, 0x67, 0x4a, 0xd1, 0x25, 0xe1, 0xc3 };

// Device Address (MSB)  01   f8   20   43
uint8_t DevAddr[4] = { 0x01,0xf8,0x20,0x43 };
