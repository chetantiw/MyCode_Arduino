...
#define OTAA_BAND     (RAK_REGION_IN865)
                     //  01    02    03    04    05    06    07    91
#define OTAA_DEVEUI   {0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x91}
#define OTAA_APPEUI   {0x0E, 0x0D, 0x0D, 0x01, 0x0E, 0x01, 0x02, 0x0E}
#define OTAA_APPKEY   {0x2B, 0x7E, 0x15, 0x16, 0x28, 0xAE, 0xD2, 0xA6, 0xAB, 0xF7, 0x15, 0x88, 0x09, 0xCF, 0x4F, 0x5F}
                  //     2b    7e    15    16    28    ae    d2    a6    ab    f7    15    88    09    cf    4f    5f
